...
def preparar_datos_completo(data):
    ...
    for item in data["datos_comunidades"]:
        comunidades.append(item["comunidad"]["nombre"])
    ...
    np.save('../../../app/data/ccaa/min_value_LT.npy', scaler.data_min_)
    np.save('../../../app/data/ccaa/max_value_LT.npy', scaler.data_max_)
    np.save('../../../app/data/ccaa/encoder_LT.npy', encoder.categories_)
...
def entrenar_modelo_gru(X, y):
    ...
    model.save('../../../app/saved_models/ccaa/longterm.h5')
